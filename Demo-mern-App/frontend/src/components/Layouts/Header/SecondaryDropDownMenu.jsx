    ...
    const navs = [
        {
            ...
            redirect: "https://www.msystechnologies.com/communication-preferences/push",
        },
        {
            title: "Sell on msystechnologies",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.msystechnologies.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.msystechnologies.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.msystechnologies.com/mobile-apps",
        },
    ]
